...
# per-modality gather: 6) can claim the whole cap and briefly queue live
# /api/* and /fhir/* traffic behind it.
...
class HippoClientPatient(HippoClient):
    ...
    def parse_data(self, html_content: str, **kwargs) -> HippoData:
        ...
        try:
            ...
            data.store("patient.allergies", extract_text_from_element(soup, element_id="strAlergii"))
            data.store("patient.attention", extract_text_from_element(soup, element_id="strAtentie"))
